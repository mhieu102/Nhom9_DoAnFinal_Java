package com.example.Nhom9_DoAnFinal_Java.Utils;

import com.example.Nhom9_DoAnFinal_Java.services.CustomUserDetailService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws
        ...
        return http.csrf().disable()
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/products", "/products/add", "product-detail/*")
